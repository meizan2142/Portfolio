...
const Skills = () => {
    return (
        <div id="skills" className="px-9">
            ...
            <div className="border border-[#365E53] rounded-md desktop:w-[450px] laptopL:w-[450px] lg:mx-56 desktop:mx-0 md:mx-32 laptopL:mx-0 lg:w-[450px] mt-10 desktop:h-16 mobile:h-32 h-20  p-3 space-y-3">
