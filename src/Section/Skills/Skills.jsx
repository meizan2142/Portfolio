    ...
    return (
        <div id="skills" className="px-9">
            <h1 className="text-[#DCE3E1] text-2xl font-medium flex items-center gap-3">
                ...
                <span className="rounded-full border border-[#272E2C] py-1 px-2 text-sm text-[#3F7D6E]">tech stack</span>
            </h1>
            <div className="border border-[#272E2C] rounded-md desktop:w-[450px] laptopL:w-[450px] lg:mx-56 desktop:mx-0 md:mx-32 laptopL:mx-0 lg:w-[450px] mt-10 desktop:h-16 mobile:h-36 h-20  p-3 space-y-3">
                <h1 className="flex items-center gap-2 text-sm font-normal">
                    ...
                    <span className='text-[#365E53]'>skills</span>
            ...
            <div className='mt-10 desktop:flex gap-6 md:grid md:grid-cols-2 space-y-0 mobile:space-y-5 laptopL:flex lg:flex desktop:mx-20 mobile:mx-0 laptopL:mx-0 md:mx-0'>
                ...
                <span className="rounded-full border border-[#272E2C] py-1 px-2 text-sm text-[#3F7D6E]">
                    ...
                    <div className=' px-3 grid grid-cols-2 mobile:px-2'>
                        ...
                        <div className="border border-[#272E2C] bg-[#0E1715] rounded-md w-28 lg:w-24 mobile:w-24 desktop:w-28  mt-6 h-18  p-3 space-y-3">
                            <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="border border-[#272E2C] bg-[#0E1715] rounded-md w-28 mobile:w-24 desktop:w-28  mt-6 h-18  p-3 space-y-3">
                            <div className="flex flex-col items-center gap-3">
