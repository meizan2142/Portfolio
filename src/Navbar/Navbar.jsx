    ...
    return (
        <nav className="flex items-center justify-between  px-4 py-2 text-white mb-24">
            ...
            <div className="flex items-center space-x-4">
                ...
                <button className="rounded-lg   mobile:hidden  bg-[#365E53] px-3 py-2 text-md text-[#DCE3E1] font-medium text-sm ease-in-out transition-all duration-200 hover:scale-110">
                    Contact me
                </button>   
            </div>
