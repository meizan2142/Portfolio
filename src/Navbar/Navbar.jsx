...
const Navbar = () => {
    ...
    return (
        <nav className={`flex items-center justify-between px-4 py-2 text-white ${scrollPosition > 50 ? 'mx-auto bg-[#0E1714] mt-4 mobile:w-full desktop:w-[1400px] md:w-full fixed z-10 border border-[#272E2C] rounded-r-full rounded-l-full' : ''}`}
        >
            ...
            <div className="flex items-center space-x-4">
                {/* <button className="border p-1 rounded-full border-[#272E2C]">
